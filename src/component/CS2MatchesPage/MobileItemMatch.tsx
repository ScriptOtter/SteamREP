...
export const MobileItemMatch = ({ ...props }) => {
  ...
  return (
    <div
      ...
      className={`mx-8 h-[130px] sm:mx-0 sm:w-full sm:h-[160px] md:h-[225px] rounded-xl bg-[url(/public/maps/de_dust2.jpg)] bg-cover bg-center cursor-pointer`}
    >
      <div
        className={cn(
        ...
        <div className="relative">
          <div className="flex items-center space-x-1 absolute top-1 left-1">
            <img
              ...
              src={`/public/map_icons/map_icon_${map}.svg`}
            />
